...
"""autogenerated by genpy from robot_msgs/MotorState.msg. Do not edit."""
import codecs
import sys
...
class MotorState(genpy.Message):
  _md5sum = "bf3a599ff7d0c7528dc0b4a11694b234"
  _type = "robot_msgs/MotorState"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float32 q            # motor current position (rad)
float32 dq           # motor current speed (rad/s)
float32 ddq          # motor current speed (rad/s)
float32 tau_est      # current estimated output torque (N*m)
float32 cur          # current estimated output cur (N*m)"""
  __slots__ = ['q','dq','ddq','tau_est','cur']
