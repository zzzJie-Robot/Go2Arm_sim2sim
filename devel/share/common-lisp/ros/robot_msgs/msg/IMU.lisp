...
(cl:defmethod cl:initialize-instance :after ((m <IMU>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IMU)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-msg:<IMU> is deprecated: use robot_msgs-msg:IMU instead.")))
...
(cl:defmethod gyroscope-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:gyroscope-val is deprecated.  Use robot_msgs-msg:gyroscope instead.")
  (gyroscope m))

(cl:ensure-generic-function 'accelerometer-val :lambda-list '(m))
(cl:defmethod accelerometer-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:accelerometer-val is deprecated.  Use robot_msgs-msg:accelerometer instead.")
  (accelerometer m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<IMU>)))
  ...
  "615f09ab254a289c43db20afb6b357e3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'IMU)))
  "Returns md5sum for a message object of type 'IMU"
  "615f09ab254a289c43db20afb6b357e3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IMU>)))
  ...
  (cl:format cl:nil "float32[4] quaternion~%float32[3] gyroscope~%float32[3] accelerometer~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IMU)))
  "Returns full string definition for message of type 'IMU"
  (cl:format cl:nil "float32[4] quaternion~%float32[3] gyroscope~%float32[3] accelerometer~%~%"))
